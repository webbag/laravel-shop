...
```
```
git clone git@github.com:webbag/laravel-shop.git
``` 
...
``` 
sudo echo "172.18.0.1 laravel-shop.lh" >> /etc/hosts
```
...
DEV
* host:       laravel-shop.lh
* port:       3306
* user:       laravel-shop
* pass:       laravel-shop
* pass_root:  laravel-shop
* db:         laravel-shop
